...
app.get('/api/data', async (req, res) => {
  try {
    ...
    try {
      // historicalTotal = ALL Zoho bills + 3 journal entries = complete inception to date spend
      // This is the single source of truth. Taconic Phase 1.1 included here from Zoho.
